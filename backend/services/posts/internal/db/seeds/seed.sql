...
('Just finished reading an amazing book on PostgreSQL triggers! 📚', 1, NULL, 'everyone'),
('Beautiful sunset today at the beach 🌅', 2, NULL, 'everyone'),
('Who else is excited for the weekend?', 3, NULL, 'everyone'),
('My new coding project is finally coming together!', 4, NULL, 'everyone'),
('Coffee and code - the perfect combination ☕💻', 5, NULL, 'everyone');
...
('Group hiking trip planned for next month! 🥾', 5, 103, 'group');
...
('Just deployed my first production app! 🚀', 1, NULL, 'everyone'),
...
BEGIN
    ...
    (4, post_ids[2], 'I love sunset photography 📸'),
    ...
    (7, post_ids[3], 'Just relaxing at home 😊');
