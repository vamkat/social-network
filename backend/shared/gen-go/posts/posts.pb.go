...
type CreatePostReq struct {
	...
	AudienceIds   *common.Int64Arr       `protobuf:"bytes,5,opt,name=audience_ids,json=audienceIds,proto3" json:"audience_ids,omitempty"`
...
func (x *CreatePostReq) GetAudienceIds() *common.Int64Arr {
	if x != nil {
...
type EditPostReq struct {
	...
	Audience      string                 `protobuf:"bytes,5,opt,name=audience,proto3" json:"audience,omitempty"`
	AudienceIds   *common.Int64Arr       `protobuf:"bytes,6,opt,name=audience_ids,json=audienceIds,proto3" json:"audience_ids,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *EditPostReq) GetAudienceIds() *common.Int64Arr {
	if x != nil {
		return x.AudienceIds
	}
	return nil
...
const file_posts_proto_rawDesc = "" +
	...
	"\tListPosts\x12!\n" +
	"\x05posts\x18\x01 \x03(\v2\v.posts.PostR\x05posts\"\xc4\x01\n" +
	...
	"\baudience\x18\x04 \x01(\tR\baudience\x123\n" +
	"\faudience_ids\x18\x05 \x01(\v2\x10.common.Int64ArrR\vaudienceIds\x12\x14\n" +
	"\x05image\x18\x06 \x01(\x03R\x05image\"\xc4\x01\n" +
	"\vEditPostReq\x12!\n" +
	...
	"\baudience\x18\x05 \x01(\tR\baudience\x123\n" +
	"\faudience_ids\x18\x06 \x01(\v2\x10.common.Int64ArrR\vaudienceIds\"\x81\x01\n" +
...
var file_posts_proto_goTypes = []any{
	...
	(*common.Int64Arr)(nil),        // 22: common.Int64Arr
...
var file_posts_proto_depIdxs = []int32{
	...
	22, // 5: posts.CreatePostReq.audience_ids:type_name -> common.Int64Arr
	22, // 6: posts.EditPostReq.audience_ids:type_name -> common.Int64Arr
	...
	6,  // 19: posts.PostsService.CreatePost:input_type -> posts.CreatePostReq
	1,  // 20: posts.PostsService.DeletePost:input_type -> posts.GenericReq
	7,  // 21: posts.PostsService.EditPost:input_type -> posts.EditPostReq
	0,  // 22: posts.PostsService.GetMostPopularPostInGroup:input_type -> posts.SimpleIdReq
	9,  // 23: posts.PostsService.GetPersonalizedFeed:input_type -> posts.GetPersonalizedFeedReq
	3,  // 24: posts.PostsService.GetPublicFeed:input_type -> posts.GenericPaginatedReq
	8,  // 25: posts.PostsService.GetUserPostsPaginated:input_type -> posts.GetUserPostsReq
	10, // 26: posts.PostsService.GetGroupPostsPaginated:input_type -> posts.GetGroupPostsReq
	13, // 27: posts.PostsService.CreateComment:input_type -> posts.CreateCommentReq
	14, // 28: posts.PostsService.EditComment:input_type -> posts.EditCommentReq
	1,  // 29: posts.PostsService.DeleteComment:input_type -> posts.GenericReq
	2,  // 30: posts.PostsService.GetCommentsByParentId:input_type -> posts.EntityIdPaginatedReq
	17, // 31: posts.PostsService.CreateEvent:input_type -> posts.CreateEventReq
	1,  // 32: posts.PostsService.DeleteEvent:input_type -> posts.GenericReq
	18, // 33: posts.PostsService.EditEvent:input_type -> posts.EditEventReq
	2,  // 34: posts.PostsService.GetEventsByGroupId:input_type -> posts.EntityIdPaginatedReq
	19, // 35: posts.PostsService.RespondToEvent:input_type -> posts.RespondToEventReq
	1,  // 36: posts.PostsService.RemoveEventResponse:input_type -> posts.GenericReq
	0,  // 37: posts.PostsService.SuggestUsersByPostActivity:input_type -> posts.SimpleIdReq
	1,  // 38: posts.PostsService.ToggleOrInsertReaction:input_type -> posts.GenericReq
	24, // 39: posts.PostsService.CreatePost:output_type -> google.protobuf.Empty
	24, // 40: posts.PostsService.DeletePost:output_type -> google.protobuf.Empty
	24, // 41: posts.PostsService.EditPost:output_type -> google.protobuf.Empty
	4,  // 42: posts.PostsService.GetMostPopularPostInGroup:output_type -> posts.Post
	5,  // 43: posts.PostsService.GetPersonalizedFeed:output_type -> posts.ListPosts
	5,  // 44: posts.PostsService.GetPublicFeed:output_type -> posts.ListPosts
	5,  // 45: posts.PostsService.GetUserPostsPaginated:output_type -> posts.ListPosts
	5,  // 46: posts.PostsService.GetGroupPostsPaginated:output_type -> posts.ListPosts
	24, // 47: posts.PostsService.CreateComment:output_type -> google.protobuf.Empty
	24, // 48: posts.PostsService.EditComment:output_type -> google.protobuf.Empty
	24, // 49: posts.PostsService.DeleteComment:output_type -> google.protobuf.Empty
	12, // 50: posts.PostsService.GetCommentsByParentId:output_type -> posts.ListComments
	24, // 51: posts.PostsService.CreateEvent:output_type -> google.protobuf.Empty
	24, // 52: posts.PostsService.DeleteEvent:output_type -> google.protobuf.Empty
	24, // 53: posts.PostsService.EditEvent:output_type -> google.protobuf.Empty
	16, // 54: posts.PostsService.GetEventsByGroupId:output_type -> posts.ListEvents
	24, // 55: posts.PostsService.RespondToEvent:output_type -> google.protobuf.Empty
	24, // 56: posts.PostsService.RemoveEventResponse:output_type -> google.protobuf.Empty
	25, // 57: posts.PostsService.SuggestUsersByPostActivity:output_type -> common.ListUsers
	24, // 58: posts.PostsService.ToggleOrInsertReaction:output_type -> google.protobuf.Empty
