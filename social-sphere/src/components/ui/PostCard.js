                    ...
                    <div className="flex flex-col gap-1">
                        {likesModalUsers.map((u) => (
                            <Link
                                ...
                                className="flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-(--muted)/10 hover:text-(--accent) transition-colors"
                            >
                                ...
                                <span className="text-sm font-medium text-foreground hover:text-(--accent) cursor-pointer">@{u.username}</span>
                            </Link>
                        ))}
                        {likesModalHasMore && (
